...
// ── Search input ──
// Centered, matching the pattern used on Services/Gallery search bars.
  ...
  return (
    <div className="flex items-center justify-center gap-1.5 border-b-2 border-zinc-200 dark:border-zinc-800 focus-within:border-zinc-400 dark:focus-within:border-zinc-500 transition-colors">
      ...
      <input
        ...
        className="min-w-0 flex-1 py-3 bg-transparent text-sm font-medium text-zinc-800 dark:text-zinc-200 placeholder:text-zinc-400 outline-none text-center"
      />
    </div>
  )
}
        ...
        return (
          <div key={i} className="abh-card flex items-center gap-3 px-4 py-4 transition-shadow duration-200 hover:shadow-md">
            ...
            <div className="min-w-0 flex-1">
              ...
              <p className="text-xs text-zinc-400 mt-0.5">{r.hubTitle} · {r.section}</p>
            </div>

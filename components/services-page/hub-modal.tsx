    ...
    <div className="fixed inset-0 z-[10100] flex items-center justify-center p-3 md:p-4">
      ...
      >
        ...
        <div className="flex-1 overflow-y-auto overscroll-contain p-5 md:p-8">
          ...
          {/* Section selector — now its own centered, shadowed group
              with a gap from the card's top edge, rather than sitting
              flush against it. */}
          <div className="mt-2 mb-6 rounded-[14px] shadow-sm bg-zinc-50/60 dark:bg-white/[0.02] border border-zinc-100 dark:border-zinc-800 px-4 py-4">
            <div role="tablist" aria-label="Service categories" className="flex flex-wrap justify-center gap-x-6 gap-y-3">
              {hub.sections.map((section, sIdx) => {
                ...
                return (
                  ...
                  >
                    <span
                      className="relative pb-1.5 text-[0.86rem] font-black tracking-tight whitespace-nowrap transition-colors duration-200 border-b-2"

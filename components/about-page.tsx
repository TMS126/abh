        ...
        <div className="max-w-[1000px] mx-auto grid md:grid-cols-2 gap-10 md:gap-14 items-center">
          <div>
            ...
            <p className="abh-body mb-6">
              {BIZ.name} is a home-based service business in Kgotsong location near Bothaville, in the Free State province, in South Africa. We started with one simple goal: make technology and important services accessible to everyone in our community — no jargon, no stress.
            </p>

...
export function LocationMap() {
  return (
    <div className="w-full h-[260px] flex flex-col items-center justify-center gap-3 bg-zinc-50 dark:bg-zinc-900 text-center px-6">
      ...
      <div>
        <p className="text-[1.05rem] font-bold text-zinc-800 dark:text-zinc-100">
          {BIZ.address}
        </p>
        <p className="text-[0.9rem] font-medium text-zinc-500 dark:text-zinc-400 mt-0.5">
      ...
      <a
        ...
        className="flex items-center gap-1.5 px-4 py-2 rounded-full text-[1.05rem] font-bold text-white transition-transform active:scale-95 hover:-translate-y-0.5"

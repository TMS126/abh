...
import { BRAND, BIZ, HUB_COLORS } from "@/lib/brand"
      ...
      <div className="max-w-[1240px] mx-auto flex flex-col items-center relative z-10 w-full mb-6">
        ...
        >
          ...
          <div className="relative z-10 w-full flex flex-col items-center px-6 sm:px-10 md:px-12 pt-8 sm:pt-10 md:pt-12 pb-10 sm:pb-12 md:pb-14">
            ...
            <div className="w-full max-w-[420px] flex flex-col items-center text-center">
              <div className="relative flex flex-col items-center gap-2 rounded-[16px] px-6 py-5 mb-4 bg-white dark:bg-zinc-900 shadow-lg transition-colors duration-200">
                ...
                <button
                  ...
                  className="flex flex-col items-center gap-1 mx-auto rounded-[10px] px-2 py-1 transition-opacity hover:opacity-80 active:scale-[0.97] animate-in fade-in duration-200"
                >
            ...
            {/* Tips pill — replaces the marquee entirely. Links out to a
                dedicated Tips page covering practical how-tos across every
                hub (creating a CV, prepping a logo brief, SASSA/SARS
                document checklists, etc.), rather than scrolling through
                a passive list of service names. */}
            <button
              onClick={() => handleNavigate("/tips")}
              className="mt-8 inline-flex items-center gap-2 px-5 py-2.5 rounded-full text-sm font-bold shadow-md transition-all duration-200 hover:-translate-y-0.5 active:scale-95"
              style={{ backgroundColor: "rgba(255,255,255,0.14)", color: cardText, border: "1px solid rgba(255,255,255,0.3)" }}
            >
              <Lightbulb size={16} weight="fill" aria-hidden="true" />
              Tips for every hub — CVs, logos &amp; more

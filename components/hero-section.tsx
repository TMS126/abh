        ...
        <div className="text-center md:text-left">
          ...
          <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center md:justify-start">
            <button
              ...
              className="inline-flex items-center justify-center gap-2 px-6 md:px-8 py-3 md:py-4 rounded-[28px] font-sans font-extrabold text-sm md:text-base bg-[#F4A261] text-white hover:bg-[#D9894B] transition-all duration-300 hover:-translate-y-1 hover:shadow-[0_10px_28px_rgba(244,162,97,0.4)]"
            >
            ...
            <a
              ...
              className="inline-flex items-center justify-center gap-2 px-6 md:px-8 py-3 md:py-4 rounded-[28px] font-sans font-extrabold text-sm md:text-base bg-wa-green text-white hover:bg-[#1ebe5a] transition-all duration-300 hover:-translate-y-1 hover:shadow-[0_10px_28px_rgba(37,211,102,0.35)]"
            >
              WhatsApp Us
            </a>
          </div>
        ...
        <div className="bg-white/10 backdrop-blur-[12px] border border-white/20 rounded-[22px] p-5 md:p-7">
          ...
          <div className="flex flex-wrap gap-2">
            {[
              ...
              <span 
                key={item.label}
                className="inline-flex items-center gap-2 bg-white/15 text-white px-3 py-1.5 rounded-[18px] text-sm"
              >
                <span 
          ...
          <div className="grid grid-cols-3 gap-3 mt-5 pt-5 border-t border-white/20 text-center">
            ...
            <div>
              <div className="font-sans font-black text-xl md:text-2xl text-[#F4A261]">📍</div>

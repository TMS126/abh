...
export function Footer() {
  ...
  return (
    <footer className="relative z-30">
      {/* Expandable content — slides up from the pill */}
      <div
        className={cn(
      ...
      {/* Pill trigger — always visible at the very bottom */}
      <div className="flex justify-center py-4 bg-white dark:bg-zinc-950 border-t border-zinc-100 dark:border-zinc-900">
        <button
          ...
          className={cn(
            "flex items-center gap-2.5 px-6 py-3 rounded-[14px] shadow-md text-xs font-black uppercase tracking-widest transition-all duration-300",
            isOpen

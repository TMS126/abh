...
export const ITEM_TIPS_MAP: Record<string, string[]> = {
  // ==================== PRINT HUB ====================
  "print|b&w print": [
  ...
  "doc|business profile basic (1 page)": [
    "What to bring: Company details, contact info, and a plain description of what you do — content only, no logo or design needed.",
    "What you get: One-page company profile typed and formatted in Word (editable) plus PDF — clean text layout, no graphics.",
    "Note: This is document prep, not design — for a visually designed profile with cover art and styled photos, ask about the Design Hub version instead.",
  ],
  "doc|business profile standard (2–3 pages)": [
    "What to bring: Services list, company background, and contact details — plain content, we don't need photos for this version.",
    "What you get: 2-3 page profile, typed and formatted with headings and structure, as Word and PDF.",
    "Note: Text-focused document, not a visual design piece — good for tenders that just need clear written information.",
  ],
  "doc|business profile premium (4–5 pages)": [
    "What to bring: Full written content — team info, mission, services, history — text only, no photos required.",
    "What you get: 4-5 page profile fully typed, proofread, and consistently formatted, as Word and PDF.",
    "Aftercare: Word version means you can edit and update content yourself going forward.",
  ],
  "doc|extra page (beyond 5)": [
    "What to bring: Extra written content ready — text only.",
    "What you get: Extra page added and formatted to match the rest of the document.",
    "Best result: Only add pages when you have enough content to justify it.",
  ],
  ...
  "design|business profile basic (1 page)": [
    ...
    "What you get: One-page visually designed profile with cover styling and layout, as Word (editable) plus PDF.",
    "Note: This is a designed piece with photos and layout — for a plain text-only version, ask about the Doc Hub option instead.",
  ],
  "design|business profile standard (2–3 pages)": [
    ...
    "What you get: 2-3 page profile with designed cover, styled sections, and photos, as Word and PDF.",
  ...
  "design|business profile premium (4–5 pages)": [
    ...
    "What you get: 4-5 page profile with designed cover, table of contents, and consistent visual styling, as Word and PDF.",
  ...
  "design|extra page (beyond 5)": [
    ...
    "What you get: Extra page matched to same visual style — same fonts, colours, layout so profile stays consistent.",
  ...
  "tech|activation only": [
    "What to bring: Laptop with Windows or Office already installed, and your own legitimate license key — we cannot activate without one.",
    "What you get: Activation completed using your key, watermark removed, personalization enabled.",
  ...
  "tech|windows install + activation": [
    "What to bring: Laptop, charger, flash drive for extra backup if needed, and your own legitimate Windows/Office license key — we install using it, we don't supply keys.",
    "What you get: Windows installed and activated with your key, drivers, Office, antivirus, old files saved to 'OldFiles' folder on desktop.",

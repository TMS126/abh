 ...
 * lib/color.ts
 *
 * Generic hex-color math — contrast ratios, luminance, and hue-preserving
 * lightness adjustment. Originally lived inline in services-page.tsx; moved
 * here since none of it is page-specific and other components/pages can
 * reuse it (e.g. any future component that needs to guarantee AA contrast
 * against a dynamic brand color).
 * ────────────────────────────────────────────────────────────────────────────
 */
